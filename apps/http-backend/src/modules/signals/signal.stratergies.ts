import { calculateSMA } from "./calculator.js";
import { ICandleData, ISMAresult, IRSIresult, IVolumeresult, level } from "./signal.types.js";
import { averageVolume } from "./calculator.js";
...
export const getSignalBySMA20 = (stocksList: ICandleData[]): ISMAresult => {
  ...
  export const calculateLevel = (candle: ICandleData,rrRatio:number =2) :level=>{
